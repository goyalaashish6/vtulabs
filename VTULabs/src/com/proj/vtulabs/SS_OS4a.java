...
public class SS_OS4a extends Activity implements OnClickListener {
	...
	public void onClick(View v) {
		...
		case R.id.progview1:
			...
			Intent a1 = new Intent(SS_OS4a.this, Webv.class);
			a1.putExtras(b1);
			startActivity(a1);
			break;
		case R.id.progdown1:
			...
			Intent a2 = new Intent(SS_OS4a.this, AndroidFileDownloader.class);
			a2.putExtras(b2);
			startActivity(a2);
			break;
		case R.id.progview2:
			...
			Intent a3 = new Intent(SS_OS4a.this, Webv.class);
			a3.putExtras(b3);
			startActivity(a3);
			break;
		case R.id.progdown2:
			...
			Intent a4 = new Intent(SS_OS4a.this, AndroidFileDownloader.class);
			a4.putExtras(b4);
			startActivity(a4);
			break;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		pn = "PROGRAM 4a";
		pd = "Program to recognize a valid arithmetic expression that uses operators +, -, * and /.";
		url1 = "http://vtulabs.comeze.com/SS&OS_LAB/4a.valarthexp.l";
		url2 = "http://vtulabs.comeze.com/SS&OS_LAB/4a.valarthexp.y";
