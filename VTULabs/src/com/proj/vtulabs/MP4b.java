...
public class MP4b extends Activity implements OnClickListener {
	...
	public void onClick(View v) {
		...
		case R.id.progview:
			...
			Intent a1 = new Intent(MP4b.this, Webv.class);
			a1.putExtras(b1);
			startActivity(a1);
			break;
		case R.id.progdown:
			...
			Intent a2 = new Intent(MP4b.this, AndroidFileDownloader.class);
			a2.putExtras(b2);
			startActivity(a2);
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		pn = "PROGRAM 4b";
		pd = "Display messages FIRE and HELP alternately with flickering effects on a 7-segment display interface for a suitable period of time. Ensure a flashing rate that makes it easy to read both the messages (Examiner does not specify these delay values nor is it necessary for the student to compute these values).";
		url = "http://vtulabs.comeze.com/MP_LAB/4b.FIREnHELP.asm";
