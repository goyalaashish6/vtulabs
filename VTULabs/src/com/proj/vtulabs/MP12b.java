...
public class MP12b extends Activity implements OnClickListener {
	...
	public void onClick(View v) {
		...
		case R.id.progview:
			...
			Intent a1 = new Intent(MP12b.this, Webv.class);
			a1.putExtras(b1);
			startActivity(a1);
			break;
		case R.id.progdown:
			...
			Intent a2 = new Intent(MP12b.this, AndroidFileDownloader.class);
			a2.putExtras(b2);
			startActivity(a2);
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		pn = "PROGRAM 12b";
		pd = "Drive an elevator interface in the following way:"
		...
		url = "http://vtulabs.comeze.com/MP_LAB/12b.ELEVATOR.asm";
