...
public class DS7 extends Activity implements OnClickListener {
	...
	public void onClick(View v) {
		...
		case R.id.progview:
			...
			Intent a1 = new Intent(DS7.this, Webv.class);
			a1.putExtras(b1);
			startActivity(a1);
			break;
		case R.id.progdown:
			...
			Intent a2 = new Intent(DS7.this, AndroidFileDownloader.class);
			a2.putExtras(b2);
			startActivity(a2);
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		pn = "PROGRAM 7";
		pd = "Design, develop, and execute a program in C++ to create a class called STACK using an array of integers and to implement the following operations by overloading the operators + and - :"
		...
		url = "http://vtulabs.comeze.com/DS_LAB/7.STACK.cpp";
