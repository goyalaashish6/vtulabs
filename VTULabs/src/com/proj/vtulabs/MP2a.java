...
public class MP2a extends Activity implements OnClickListener {
	...
	public void onClick(View v) {
		...
		case R.id.progview:
			...
			Intent a1 = new Intent(MP2a.this, Webv.class);
			a1.putExtras(b1);
			startActivity(a1);
			break;
		case R.id.progdown:
			...
			Intent a2 = new Intent(MP2a.this, AndroidFileDownloader.class);
			a2.putExtras(b2);
			startActivity(a2);
