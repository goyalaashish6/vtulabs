...
public class WEB10 extends Activity implements OnClickListener {
	...
	public void onClick(View v) {
		...
		case R.id.progview:
			...
			Intent a1 = new Intent(WEB10.this, Webv.class);
			a1.putExtras(b1);
			startActivity(a1);
			break;
		case R.id.progdown:
			...
			Intent a2 = new Intent(WEB10.this, AndroidFileDownloader.class);
			a2.putExtras(b2);
			startActivity(a2);
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		pn = "PROGRAM 10";
		pd = "Write a PHP program to store page views count in SESSION, to increment the count on each refresh, and to show the count on web page.";
		url = "http://vtulabs.comeze.com/WP_LAB/10.Prog10";
