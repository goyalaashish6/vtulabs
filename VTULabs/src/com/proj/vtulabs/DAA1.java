...
public class DAA1 extends Activity implements OnClickListener {
	...
	public void onClick(View v) {
		...
		case R.id.progview:
			...
			Intent a1 = new Intent(DAA1.this, Webv.class);
			a1.putExtras(b1);
			startActivity(a1);
			break;
		...
		case R.id.progdown:
			...
			Intent a2 = new Intent(DAA1.this, AndroidFileDownloader.class);
			a2.putExtras(b2);
			startActivity(a2);
			break;
		}
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		url = "http://vtulabs.comeze.com/DAA_LAB/1.QUICKSORT.c";
